    ...
    <div className="min-h-screen bg-slate-50 flex">
      <aside className="w-64 bg-white/60 border-r border-slate-200 p-6">
        ...
        <nav className="space-y-2 text-slate-600 text-sm">
          ...
          <a href="/account/CreateOSAAccount" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Manage Users
          </a>
          <a href="/account/CreateStudentAccount" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Manage Students
          </a>
          <a href="/account/ImportStudentAccount" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Import Students
          </a>
