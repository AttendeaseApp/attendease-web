    ...
    <div className="min-h-screen bg-slate-50 flex">
      <aside className="w-64 bg-white/60 border-r border-slate-200 p-6">
        ...
        <nav className="space-y-2 text-slate-600 text-sm">
          <a href="/" className="block px-3 py-2 rounded-lg bg-indigo-50 text-indigo-700">
            Dashboard
          </a>
          <a href="/account/create-osa-account" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Manage Users
          </a>
          <a href="/account/create-student-account" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Manage Students
          </a>
          <a href="/account/import-student-account" className="block px-3 py-2 rounded-lg hover:bg-slate-100">
            Import Students
          </a>
          <div className="mt-6 border-t pt-4 text-xs text-slate-400">OTHERS</div>
          <a href="#" className="block px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-600">
            Settings
          </a>
          <a href="#" className="block px-3 py-2 rounded-lg hover:bg-slate-100 text-slate-600">
            Accounts
