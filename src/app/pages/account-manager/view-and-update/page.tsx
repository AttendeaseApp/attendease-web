        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-4">
            ...
            <div>
              ...
              <Input
                defaultValue={accountDetails.status}
                className="border border-sky-300 focus:border-sky-500"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  {date ? date.toLocaleDateString() : accountDetails.birthday}
                </Button>
              </PopoverTrigger>
        ...
        <div className="flex flex-col space-y-4">
          ...
          >
            ...
            <span className="text-xs text-black leading-tight">
              ...
              database. The student will be required to registered its facial data again.
            </span>
          </Button>
        </div>
      )}
