    ...
    <Table>
      <TableHeader className="bg-gray-100">
        <TableRow>
          ...
          <TableHead className="font-semibold text-gray-900">Registration Start</TableHead>
      ...
      <TableBody>
        {loading ? (
          ...
          <TableRow>
            <TableCell colSpan={6} className="text-center py-8">
              There are no ONGOING, UPCOMING, or even REGISTRATION events has found
            </TableCell>
          </TableRow>
        ) : (
          events.map((event) => (
            <TableRow key={event.eventId}>
              ...
              <TableCell>
                <Button size="sm" variant="outline" onClick={() => onViewAttendees(event.eventId)}>
