              ...
              <div className="flex flex-col gap-3">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      id="reg-date"
                    >
                      {getDateDisplay(formData.timeInRegistrationStartDateTime)}
                  ...
                  <PopoverContent className="w-auto overflow-hidden p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={formData.timeInRegistrationStartDateTime}
                      onSelect={(selectedDate) =>
                        handleDateSelect("timeInRegistrationStartDateTime", selectedDate)
                      }
                      initialFocus
                    />
                  </PopoverContent>
                ...
                <div className="flex items-center gap-1">
                  <Input
                    ...
                    min={1}
                    max={12}
                    value={getHour12(formData.timeInRegistrationStartDateTime)}
                    onChange={(e) =>
                      updateTime(
                  ...
                  <Input
                    ...
                    max={59}
                    step={1}
                    value={getMinute(formData.timeInRegistrationStartDateTime)}
                    onChange={(e) =>
                      updateTime(
                        "timeInRegistrationStartDateTime",
                        undefined,
                  ...
                  />
                  <Select
                    value={getPeriod(formData.timeInRegistrationStartDateTime)}
                    onValueChange={(value) =>
                      updateTime(
                        "timeInRegistrationStartDateTime",
                        undefined,
              ...
              <div className="flex flex-col gap-3">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto overflow-hidden p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(selectedDate) => handleDateSelect("startDateTime", selectedDate)}
                      initialFocus
                    />
                  </PopoverContent>
                </Popover>
                ...
                <div className="flex items-center gap-1">
                  <Input
                    ...
                    onChange={(e) =>
                      updateTime("startDateTime", e.target.value, undefined, undefined)
                    }
                    className="w-16 h-10"
                    placeholder="1"
                  />
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateTime("startDateTime", undefined, e.target.value, undefined)
                    }
                    className="w-16 h-10"
                    placeholder="00"
                  />
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateTime("startDateTime", undefined, undefined, value as "AM" | "PM")
                    }
                  >
                    <SelectTrigger className="w-20 h-10">
                      <SelectValue placeholder="AM/PM" />
              ...
              <div className="flex flex-col gap-3">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto overflow-hidden p-0" align="start">
                    <Calendar
                      ...
                      onSelect={(selectedDate) => handleDateSelect("endDateTime", selectedDate)}
                      initialFocus
                    />
                  </PopoverContent>
                </Popover>
                ...
                <div className="flex items-center gap-1">
                  <Input
                    ...
                    onChange={(e) =>
                      updateTime("endDateTime", e.target.value, undefined, undefined)
                    }
                    className="w-16 h-10"
                    placeholder="1"
                  />
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateTime("endDateTime", undefined, e.target.value, undefined)
                    }
                    className="w-16 h-10"
                    placeholder="00"
                  />
                  <Select
                    ...
                    onValueChange={(value) =>
                      updateTime("endDateTime", undefined, undefined, value as "AM" | "PM")
                    }
                  >
                    <SelectTrigger className="w-20 h-10">
                      <SelectValue placeholder="AM/PM" />
