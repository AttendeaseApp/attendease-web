        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange("timeInRegistrationStartDateTime", e.target.value)
                }
                className={errors.timeInRegistrationStartDateTime ? "border-red-500" : ""}
              />
              {errors.timeInRegistrationStartDateTime && (
                <p className="text-sm text-red-500">{errors.timeInRegistrationStartDateTime}</p>
              )}
            </div>
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => handleInputChange("eventStatus", value)}
            >
              <SelectTrigger id="status">
                <SelectValue placeholder="Select status" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value={EventStatus.CANCELLED}>{EventStatus.CANCELLED}</SelectItem>
              </SelectContent>
            </Select>
          </div>

          {errors.general && (
            <p className="text-sm text-red-500 p-2 bg-red-50 rounded">{errors.general}</p>
          )}
